	...
	return (
		<div className="flex" style={{ height: "100dvh" }}>
			<div className="relative flex h-full w-full overflow-hidden">
								...
								<div className="text-center relative mx-auto grid w-full max-w-5xl flex-1 grid-cols-1 gap-6 p-6 md:grid-cols-2">
									...
									<section className="col-span-1 md:col-span-2 rounded-2xl border border-white/20 bg-white/10 p-6 backdrop-blur-2xl text-white shadow-[0_20px_50px_rgba(0,0,0,0.35)]">
										...
										<p className="mt-2 text-sm text-amber-300/80 bg-amber-500/10 border border-amber-500/20 rounded-lg px-3 py-2 inline-block">
											📱 <strong>Swipe gestures are mobile-only</strong> (screen width &lt; 640px).
										...
										<div className="mt-10 flex flex-col items-center gap-8">
											<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 w-full max-w-3xl mx-auto">
												...
												<button
													...
													type="button"
													className="flex flex-col items-center gap-3 p-6 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-amber-400/50 hover:shadow-[0_0_20px_rgba(251,191,36,0.1)] transition-all group cursor-pointer"
												>
													<div className="p-3 rounded-xl bg-white/5 group-hover:bg-amber-400/10 transition-colors">
														<svg
															width="24"
															height="24"
															viewBox="0 0 24 24"
				...
				{/* Secondary bottom bar — opened programmatically only, no swipe-to-open */}
				<SwipeBarBottom
					id="secondary"
					sidebarHeightPx={Math.floor(window.innerHeight * 0.6)}
					isAbsolute
					swipeToOpen={false}
					showToggle={false}
					swipeBarZIndex={35}
				...
				>
					<div className="flex h-full flex-col p-4 gap-4 overflow-y-auto overscroll-contain">
						<div className="flex items-center justify-between">
							<div className="text-lg font-semibold text-amber-400">Secondary Panel</div>
							<button
								type="button"
								onClick={() => closeSidebar("bottom", { id: "secondary" })}
								className="rounded-lg border border-amber-400/20 bg-amber-400/10 px-3 py-1 text-sm hover:bg-amber-400/20 text-amber-300"
							>
								Close
							</button>
						</div>
						<p className="text-sm text-white/70">
							This panel opens only programmatically. Once open, you can swipe down to close it. The
							primary bottom bar's state is independent.
						</p>
						<div className="grid grid-cols-2 gap-3">
							<div className="rounded-xl border border-amber-400/20 bg-amber-400/5 p-4">
								<div className="text-sm text-amber-300/80">Notifications</div>
								<div className="mt-2 text-2xl font-bold text-amber-400">12</div>
							</div>
							<div className="rounded-xl border border-amber-400/20 bg-amber-400/5 p-4">
								<div className="text-sm text-amber-300/80">Messages</div>
								<div className="mt-2 text-2xl font-bold text-amber-400">5</div>
							</div>
						</div>
						<div className="grid grid-cols-2 gap-3">
							<div className="rounded-xl border border-amber-400/20 bg-amber-400/5 p-4">
						...
						<div className="mt-auto text-center text-xs text-white/40">
							Swipe down to close — or tap the Close button
						</div>
					</div>
				</SwipeBarBottom>
			</div>
