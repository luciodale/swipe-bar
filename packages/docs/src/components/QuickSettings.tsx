	...
	return (
		<div className="rounded-2xl border border-white/10 bg-slate-800/50 p-5 text-white md:col-span-2">
			...
			<p className="text-white/70 text-sm mb-4">
				The ToggleComponent prop is available on SwipeBarLeft, SwipeBarRight, and SwipeBarBottom.
				Use it to replace the default toggle button with your own custom component.
			</p>
